...
const meditations = [
    ...
    // },
    {
        id: 3,
        date: "2025-10-30",
        description: "לתת למחשבות להיות ומשפטי מטה",
        audioSrc: "audio/2025-10-30_processed.m4a",
        duration: "32 דקות",
        longDescription: "המדיטציה מציעה תרגול של השתרשות והרפיה במרחב הפנימי, התמודדות רכה עם מחשבות טורדניות, חיבור לעוגן הנשימה, וטיפוח חמלה עצמית וחמלה כלפי אחרים באמצעות תרגול 'מטה'.",
